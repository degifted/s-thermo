...
float ds18b20_gettemp() {
	...
	//apply strong pull-up for parasite powered operation
	DS18B20_PORT |= (1<<DS18B20_DQ); //high
	DS18B20_DDR |= (1<<DS18B20_DQ); //output
	_delay_ms(760); //tconv
	...
	//compose the float temperature value and return it
